...
def logging_test(logger):
    ...
    logger.warning("No value in database. Use default value.")
    logger.log(level, "Custom log here.")
    logger.error("Strlen want 'str', get 'None' instead")
    logger.fatal("Game shutdown: 'FILE_MISSING'")
...
def my_config():
    ...
    logging.basicConfig(filename='log.log', level=logging.DEBUG, format=log_format, filemode='w')
...
if __name__ == "__main__":
    ...
    logger = logging.getLogger('awesome_logger')
